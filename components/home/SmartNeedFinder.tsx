    ...
    <section id="need-finder" className="py-24 bg-tlg-ivory relative">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16 animate-reveal-up">
          ...
          <p className="text-lg text-gray-500 max-w-2xl mx-auto font-light">Select an area of interest and we will guide you to the right expertise across our global ecosystem.</p>
        </div>
              ...
              <div className="animate-reveal-up grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                {needs.map((n) => (
                  ...
                  >
                    ...
                    <span className="text-xs text-gray-500 font-light leading-relaxed">{n.desc}</span>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  {locations.map((l) => (
                    ...
                    >
                      ...
                      <span className="text-sm text-gray-400 font-light uppercase tracking-widest flex items-center">
                        Select Market <ArrowRight size={14} className="ml-2 opacity-0 group-hover:opacity-100 transition-opacity" />
                      </span>
                    </button>
                  ))}
                </div>
                <button onClick={() => setStep(1)} className="mt-12 text-sm text-gray-400 hover:text-tlg-charcoal font-medium flex items-center justify-center focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-tlg-signatureGold rounded px-4 py-2 mx-auto w-max transition-colors">
            ...
            {step === 3 && recommendation && (
              <div className="animate-reveal-up h-full flex items-center justify-center py-8">
                <div className="max-w-2xl w-full bg-white p-12 border border-tlg-stone shadow-2xl relative">
                  ...
                  <button onClick={() => setStep(1)} className="absolute top-6 right-6 text-xs text-gray-400 hover:text-tlg-charcoal uppercase tracking-widest font-medium focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-tlg-signatureGold rounded">
                    Restart
                  </button>
                </div>
              </div>
