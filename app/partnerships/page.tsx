...
export default function PartnershipsPage() {
 ...
 <span className="text-tlg-signatureGold text-[11px] md:text-xs font-bold uppercase tracking-[0.3em] mb-6 block">Partnerships</span>
 ...
 <ul className="space-y-4 text-sm text-gray-800 font-normal mb-12">
