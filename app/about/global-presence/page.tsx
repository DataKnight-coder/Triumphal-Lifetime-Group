...
export default function GlobalPresencePage() {
 ...
 Serving as our headquarters for Middle Eastern and global operations, our Dubai presence anchors our consulting, real estate, and technology divisions. It is a primary hub for international companies establishing a footprint in the MENA region.
 </p>
 ...
 Contact UAE Office <ArrowRight size={14} className="ml-2" />
 </Link>
 </div>
 </div>
 ...
 <h4 className="text-2xl font-serif text-tlg-midnight mb-6">The African Anchor</h4>
 <p className="text-gray-800 font-normal leading-relaxed mb-6">
 ...
 <Image src="/visuals/global-mobility.jpg" alt="Abuja Nigeria" fill className="object-cover group-hover:scale-105 transition-transform duration-1000 z-0" />
 <div className="absolute inset-0 bg-gradient-to-t from-tlg-midnight via-tlg-midnight/40 to-transparent z-10" />
 <div className="relative z-20 flex flex-col h-full">
 <span className="text-4xl font-serif text-white mb-auto">02</span>
 <h3 className="text-4xl font-serif text-white mb-2">Abuja</h3>
 ...
 <p className="text-gray-800 font-normal leading-relaxed mb-6">
 Our North American presence facilitates educational advisory, bilateral trade support, and corporate relocation processing, connecting African and Middle Eastern talent with Canadian opportunities.
 </p>
 <Link href="/contact" className="text-xs font-bold uppercase tracking-widest text-tlg-midnight hover:text-tlg-signatureGold transition-colors inline-flex items-center">
 Contact Canada Office <ArrowRight size={14} className="ml-2" />
 </Link>
 </div>
 </div>
