      ...
      <main className="bg-tlg-ivory">
        ...
        <section className="relative h-screen min-h-[700px] w-full flex flex-col justify-end overflow-hidden bg-tlg-midnight">
          ...
          <div className="max-w-[1600px] w-full mx-auto px-6 md:px-12 relative z-10 pb-24 md:pb-32">
            ...
            <h1 className="text-5xl md:text-7xl lg:text-[7rem] font-serif text-white leading-[0.9] tracking-tight mb-8 animate-reveal-up-delayed">
              HR & Business<br />
              <span className="italic font-light text-white/80">Consulting.</span>
            </h1>
            ...
            <p className="text-xl md:text-2xl text-white/80 font-light max-w-3xl leading-relaxed animate-reveal-up-delayed">
              Architecting resilient human capital infrastructures and corporate strategies for organizations scaling across borders.
            </p>
          </div>
        </section>
        ...
        <section className="py-24 md:py-32 bg-white relative border-b border-tlg-stone">
          <div className="max-w-[1200px] mx-auto px-6 text-center">
            ...
            <h2 className="text-3xl md:text-5xl font-serif text-tlg-midnight leading-[1.3]">
              "True enterprise growth is impossible without structural resilience. We don't just recruit talent; we engineer the systems that allow human capital to thrive globally."
            </h2>
          </div>
        </section>
        ...
        <section className="py-32 bg-tlg-ivory relative">
          <div className="max-w-[1600px] mx-auto px-6 md:px-12">
            ...
            <div className="flex flex-col md:flex-row justify-between items-end mb-20">
              ...
              <p className="text-gray-500 font-light max-w-sm mt-6 md:mt-0">Precision-engineered solutions tailored for complex regulatory environments in Nigeria, UAE, and Canada.</p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-12 gap-8 md:gap-12">
              ...
              <div className="md:col-span-8 group relative overflow-hidden bg-white shadow-sm border border-tlg-stone">
                <div className="h-[400px] relative overflow-hidden">
                  <div className="absolute inset-0 bg-cover bg-center group-hover:scale-105 transition-transform duration-[1.5s]" style={{ backgroundImage: "url('https://images.unsplash.com/photo-1522071820081-009f0129c71c?q=80&w=2070&auto=format&fit=crop')" }}></div>
                ...
                <div className="p-12">
                  ...
                  <h3 className="text-3xl font-serif text-tlg-midnight mb-6">Organizational Structuring</h3>
                  <p className="text-gray-500 font-light leading-relaxed mb-8 max-w-2xl">
                    We evaluate your current operational framework and redesign it for international scalability. From compliance audits to defining reporting hierarchies across subsidiaries, we build the scaffolding your company needs to expand securely.
                  </p>
                  <ul className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-sm font-semibold text-tlg-midnight">
                    <li className="flex items-center gap-3"><CheckCircle2 size={16} className="text-tlg-signatureGold"/> Cross-Border Compliance</li>
                    <li className="flex items-center gap-3"><CheckCircle2 size={16} className="text-tlg-signatureGold"/> Policy Development</li>
                    <li className="flex items-center gap-3"><CheckCircle2 size={16} className="text-tlg-signatureGold"/> HR Framework Audits</li>
                    <li className="flex items-center gap-3"><CheckCircle2 size={16} className="text-tlg-signatureGold"/> Expansion Advisory</li>
                  </ul>
                </div>
              </div>
              ...
              <div className="md:col-span-4 group relative overflow-hidden bg-tlg-midnight text-white shadow-sm flex flex-col">
                <div className="h-[300px] relative overflow-hidden shrink-0">
                  <div className="absolute inset-0 bg-cover bg-center group-hover:scale-105 transition-transform duration-[1.5s] opacity-70 mix-blend-luminosity" style={{ backgroundImage: "url('https://images.unsplash.com/photo-1556761175-5973dc0f32b7?q=80&w=1932&auto=format&fit=crop')" }}></div>
                </div>
                <div className="p-10 flex-1 flex flex-col justify-center border-t border-white/10">
                  ...
                  <h3 className="text-2xl font-serif mb-4">Executive Search</h3>
                  <p className="text-white/70 font-light leading-relaxed text-sm">
                    Targeted acquisition for C-suite and pivotal leadership roles. We leverage a proprietary global network to secure leaders capable of navigating international complexities.
                  </p>
                </div>
              </div>
              ...
              <div className="md:col-span-5 group relative overflow-hidden bg-white shadow-sm border border-tlg-stone flex flex-col">
                <div className="p-10 flex-1 flex flex-col justify-center">
                  ...
                  <h3 className="text-2xl font-serif text-tlg-midnight mb-4">Talent Development</h3>
                  <p className="text-gray-500 font-light leading-relaxed text-sm mb-6">
                    Bespoke training protocols designed to elevate existing workforces. We bridge cultural gaps and implement performance management systems that drive measurable ROI.
                  </p>
                  <Link href="/book" className="text-xs uppercase tracking-widest font-bold text-tlg-midnight hover:text-tlg-signatureGold transition-colors flex items-center group-hover:translate-x-2">Inquire About Training <ArrowRight size={14} className="ml-2"/></Link>
                </div>
              </div>
              ...
              <div className="md:col-span-7 group relative overflow-hidden bg-white shadow-sm border border-tlg-stone flex items-center">
                <div className="w-1/2 h-full absolute right-0 top-0 overflow-hidden hidden md:block">
                  <div className="absolute inset-0 bg-cover bg-center group-hover:scale-105 transition-transform duration-[1.5s]" style={{ backgroundImage: "url('https://images.unsplash.com/photo-1573165231977-3f0e27806045?q=80&w=2069&auto=format&fit=crop')" }}></div>
                </div>
                <div className="w-full md:w-1/2 p-10 md:p-12 relative z-10 bg-white md:bg-white/95 backdrop-blur-sm h-full flex flex-col justify-center">
                  ...
                  <h3 className="text-2xl font-serif text-tlg-midnight mb-4">Retained HR Support</h3>
                  <p className="text-gray-500 font-light leading-relaxed text-sm">
                    Comprehensive, ongoing advisory services. We act as an extension of your leadership team, handling complex employee relations, dispute resolution, and continuous policy refinement.
                  </p>
                </div>
              </div>
        ...
        <section className="py-24 bg-tlg-emerald relative border-y border-tlg-emerald">
          ...
          <div className="max-w-[1600px] mx-auto px-6 md:px-12 relative z-10 grid grid-cols-2 md:grid-cols-4 gap-12 text-center">
            <div>
              ...
              <p className="text-[10px] uppercase tracking-widest text-tlg-signatureGold font-bold">Global Hubs</p>
            </div>
            <div>
              <h4 className="text-4xl md:text-5xl font-serif text-white mb-2">100+</h4>
              <p className="text-[10px] uppercase tracking-widest text-tlg-signatureGold font-bold">Corporate Audits</p>
            </div>
            <div>
              <h4 className="text-4xl md:text-5xl font-serif text-white mb-2">300+</h4>
              <p className="text-[10px] uppercase tracking-widest text-tlg-signatureGold font-bold">Executives Placed</p>
            </div>
            <div>
              <h4 className="text-4xl md:text-5xl font-serif text-white mb-2">100%</h4>
              <p className="text-[10px] uppercase tracking-widest text-tlg-signatureGold font-bold">Compliance Rate</p>
            </div>
          </div>
        </section>
        ...
        <section className="py-32 bg-white relative flex flex-col items-center justify-center text-center">
          <div className="max-w-3xl px-6">
            ...
            <h2 className="text-4xl md:text-5xl font-serif text-tlg-midnight mb-8">Secure Your Enterprise Future</h2>
            <p className="text-gray-500 font-light leading-relaxed mb-12 text-lg">
              Whether you are establishing a new subsidiary or auditing an existing workforce, our specialists are ready to architect your success.
            </p>
