    ...
    <>
        ...
        <section className="relative min-h-[85vh] w-full flex flex-col justify-end overflow-hidden bg-[#f4ece3] pt-32 pb-24">
          <div className="absolute inset-0 z-0">
            <div 
              className="absolute inset-0 bg-cover bg-center animate-slow-zoom scale-105 opacity-30"
              style={{ backgroundImage: "url('/images/impact_hero.jpg')" }}
            ></div>
          ...
          <div className="max-w-[1200px] w-full mx-auto px-6 md:px-12 relative z-10 text-center">
            ...
            <h1 className="text-5xl md:text-7xl lg:text-[7rem] font-serif text-tlg-midnight leading-[0.9] tracking-tight mb-8 animate-reveal-up-delayed">
              Charity<br />
              <span className="italic font-light text-gray-500">Foundation.</span>
            </h1>
            <p className="text-xl md:text-2xl text-gray-700 font-light max-w-3xl mx-auto leading-relaxed animate-reveal-up-delayed mt-12">
        ...
        <section className="py-24 md:py-32 bg-white relative border-b border-tlg-stone">
          <div className="max-w-[1200px] mx-auto px-6 text-center">
            <span className="text-gray-400 text-xs font-bold uppercase tracking-[0.2em] block mb-8">Our Commitment</span>
        ...
        <section className="py-32 bg-tlg-ivory relative">
          <div className="max-w-[1600px] mx-auto px-6 md:px-12">
            ...
            <div className="flex flex-col md:flex-row justify-between items-end mb-20">
              ...
              <p className="text-gray-500 font-light max-w-sm mt-6 md:mt-0 leading-relaxed">Targeted, data-driven philanthropic initiatives designed to solve foundational societal challenges.</p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-12 gap-8 md:gap-12">
              ...
              <div className="md:col-span-8 group relative overflow-hidden bg-white shadow-sm border border-tlg-stone">
                ...
                <div className="p-12 border-t border-tlg-stone bg-white">
                  <span className="text-tlg-signatureGold text-[10px] uppercase font-bold tracking-[0.2em] mb-4 block">01</span>
                  <h3 className="text-3xl font-serif text-tlg-midnight mb-6">Educational Infrastructure</h3>
                  <p className="text-gray-600 font-light leading-relaxed mb-8 max-w-2xl">
              ...
              <div className="md:col-span-4 group relative overflow-hidden bg-[#f4ece3] shadow-sm border border-tlg-stone flex flex-col">
                ...
                <div className="p-10 flex-1 flex flex-col justify-center border-t border-tlg-stone bg-white">
                  <span className="text-tlg-signatureGold text-[10px] uppercase font-bold tracking-[0.2em] mb-4 block">02</span>
              ...
              <div className="md:col-span-5 group relative overflow-hidden bg-white shadow-sm border border-tlg-stone flex flex-col">
                <div className="p-10 flex-1 flex flex-col justify-center">
                  <span className="text-tlg-signatureGold text-[10px] uppercase font-bold tracking-[0.2em] mb-4 block">03</span>
                  <h3 className="text-2xl font-serif text-tlg-midnight mb-4">Economic Empowerment</h3>
                  <p className="text-gray-600 font-light leading-relaxed text-sm mb-8">
              ...
              <div className="md:col-span-7 group relative overflow-hidden bg-white shadow-sm border border-tlg-stone flex items-center">
                ...
                <div className="w-full md:w-1/2 p-10 md:p-12 relative z-10 bg-white md:bg-white/95 backdrop-blur-sm h-full flex flex-col justify-center border-r md:border-none border-tlg-stone">
                  <span className="text-tlg-signatureGold text-[10px] uppercase font-bold tracking-[0.2em] mb-4 block">04</span>
        ...
        <section className="py-24 bg-white relative border-y border-tlg-stone">
          <div className="max-w-[1600px] mx-auto px-6 md:px-12 relative z-10 grid grid-cols-2 md:grid-cols-4 gap-12 text-center">
            <div>
              ...
              <p className="text-[10px] uppercase tracking-[0.2em] text-gray-400 font-bold">Capital Deployed</p>
            </div>
            <div>
              <h4 className="text-4xl md:text-5xl font-serif text-tlg-midnight mb-2">10k+</h4>
              <p className="text-[10px] uppercase tracking-[0.2em] text-gray-400 font-bold">Lives Impacted</p>
            </div>
            <div>
              <h4 className="text-4xl md:text-5xl font-serif text-tlg-midnight mb-2">15+</h4>
              <p className="text-[10px] uppercase tracking-[0.2em] text-gray-400 font-bold">Global Partnerships</p>
            </div>
            <div>
              <h4 className="text-4xl md:text-5xl font-serif text-tlg-midnight mb-2">100%</h4>
              <p className="text-[10px] uppercase tracking-[0.2em] text-gray-400 font-bold">Transparency Guarantee</p>
            </div>
          </div>
        </section>
        ...
        <section className="py-32 bg-tlg-ivory relative flex flex-col items-center justify-center text-center">
          <div className="max-w-3xl px-6">
            ...
            <div className="flex flex-col sm:flex-row justify-center gap-6">
              ...
              <Link href="/book" className="inline-flex justify-center items-center bg-transparent border border-tlg-stone text-tlg-midnight px-10 py-5 text-xs font-bold uppercase tracking-[0.2em] hover:border-tlg-midnight transition-colors">
                Request A Grant
              </Link>
            </div>
          </div>
