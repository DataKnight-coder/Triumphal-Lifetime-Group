...
export const metadata: Metadata = {
  ...
  description: "Important legal information and limitations of liability.",
};
    ...
    <main className="bg-white pt-32 pb-24">
      ...
      <section className="py-24">
        <div className="max-w-[1000px] mx-auto px-6 md:px-12 prose prose-lg prose-headings:font-serif prose-headings:text-tlg-midnight prose-p:text-gray-600 prose-p:font-light prose-a:text-tlg-signatureGold hover:prose-a:text-tlg-midnight max-w-none">
          ...
          <p>
            This is a placeholder for the Legal Disclaimer. Please provide the official legal text to replace this content. We are committed to maintaining the highest standards of corporate governance, transparency, and compliance across all our operating jurisdictions, including the UAE, Canada, and Nigeria.
          </p>
