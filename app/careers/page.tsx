      ...
      <section className="relative pt-16 pb-24 border-b border-tlg-stone bg-tlg-ivory">
        <div className="max-w-[1200px] mx-auto px-6 md:px-12">
          <div className="max-w-4xl animate-reveal-up">
            <span className="text-tlg-signatureGold text-[10px] md:text-xs font-bold uppercase tracking-[0.3em] mb-6 block">Careers</span>
        ...
        <div className="max-w-[1000px] mx-auto px-6 md:px-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 mb-24">
            <div>
              ...
              <p className="text-sm text-gray-600 font-light leading-relaxed">Work on cross-border projects spanning North America, the Middle East, and Africa, gaining significant international business experience.</p>
            </div>
            <div>
              <h4 className="text-lg font-serif text-tlg-midnight mb-3">Integrated Ecosystem</h4>
              <p className="text-sm text-gray-600 font-light leading-relaxed">Collaborate daily with specialists in HR, real estate, and technology, broadening your professional perspective beyond a single discipline.</p>
            </div>
            <div>
              <h4 className="text-lg font-serif text-tlg-midnight mb-3">Meritocratic Growth</h4>
              <p className="text-sm text-gray-600 font-light leading-relaxed">Advancement is based strictly on performance, client impact, and leadership capability—not tenure.</p>
            </div>
            <div>
              <h4 className="text-lg font-serif text-tlg-midnight mb-3">Continuous Learning</h4>
              <p className="text-sm text-gray-600 font-light leading-relaxed">Leverage our internal Digital Learning division to continually upskill and stay ahead of industry trends.</p>
            </div>
          </div>
