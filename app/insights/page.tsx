...
export default function InsightsPage() {
 ...
 {/* Article 1 */}
 <Link href="/insights/express-entry-canada-2026" className="group flex flex-col border border-tlg-stone hover:border-tlg-midnight transition-colors h-full">
 ...
 <span className="text-[11px] uppercase font-bold tracking-widest text-tlg-signatureGold mb-3">Global Mobility</span>
 <h3 className="text-xl font-serif text-tlg-midnight mb-3">Navigating the Canadian Express Entry System in 2026</h3>
 <p className="text-sm text-gray-800 font-normal mb-8 flex-1">
 ...
 <div className="p-8 flex flex-col flex-1 bg-white">
 <span className="text-[11px] uppercase font-bold tracking-widest text-tlg-signatureGold mb-3">Real Estate</span>
 ...
 <div className="p-8 flex flex-col flex-1 bg-white">
 <span className="text-[11px] uppercase font-bold tracking-widest text-tlg-signatureGold mb-3">HR Consulting</span>
