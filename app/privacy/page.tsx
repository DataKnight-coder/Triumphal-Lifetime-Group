...
export default function PrivacyPage() {
 ...
 <p className="text-sm text-gray-700 font-normal mb-3">For privacy-related questions, data access requests, or deletion requests, please contact our team directly.</p>
