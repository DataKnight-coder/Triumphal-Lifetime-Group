...
const dirPath = path.join('app', 'careers', 'apply');
    ...
    <main className="bg-white pt-32 pb-24">
      <section className="relative pt-16 pb-24 border-b border-tlg-stone bg-tlg-ivory">
        <div className="max-w-[1000px] mx-auto px-6 md:px-12">
          <Link href="/careers" className="inline-flex items-center text-xs font-bold uppercase tracking-[0.2em] text-gray-400 hover:text-tlg-midnight transition-colors mb-12">
            <ArrowRight size={14} className="mr-2 rotate-180" /> Back to Careers
          </Link>
          <div className="max-w-3xl animate-reveal-up">
            <span className="text-tlg-signatureGold text-[10px] md:text-xs font-bold uppercase tracking-[0.3em] mb-6 block">Join Our Network</span>
          ...
          <form className="space-y-12 animate-reveal-up-delayed">
            ...
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  <label htmlFor="division" className="block text-xs font-bold uppercase tracking-widest text-gray-500 mb-2">Target Division</label>
            ...
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                  <label htmlFor="phone" className="block text-xs font-bold uppercase tracking-widest text-gray-500 mb-2">Phone Number</label>
                ...
                <div>
                  <label htmlFor="country" className="block text-xs font-bold uppercase tracking-widest text-gray-500 mb-2">Country of Residence</label>
                ...
                <div>
                  <label htmlFor="linkedin" className="block text-xs font-bold uppercase tracking-widest text-gray-500 mb-2">LinkedIn Profile URL</label>
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-6">
                <div>
                  <label className="block text-xs font-bold uppercase tracking-widest text-gray-500 mb-2">CV / Resume (PDF)</label>
                  <div className="w-full border-2 border-dashed border-tlg-stone bg-tlg-ivory hover:border-tlg-signatureGold transition-colors flex flex-col items-center justify-center py-12 cursor-pointer group">
                    <Upload className="text-gray-400 group-hover:text-tlg-signatureGold transition-colors mb-4" />
                    <span className="text-sm font-semibold text-tlg-midnight">Click to upload file</span>
                    <span className="text-xs text-gray-500 mt-2">Maximum file size: 5MB</span>
                  </div>
                </div>
                <div>
                  <label htmlFor="coverLetter" className="block text-xs font-bold uppercase tracking-widest text-gray-500 mb-2">Cover Letter / Statement of Purpose</label>
...
console.log('Created careers apply page');
