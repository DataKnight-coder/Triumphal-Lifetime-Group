...
const pages = [
  { path: 'cookie-policy', title: 'Cookie Policy', description: 'Information about how we use cookies and tracking technologies.' },
  { path: 'refund-policy', title: 'Refund Policy', description: 'Our policy regarding refunds and service cancellations.' },
  { path: 'disclaimer', title: 'Legal Disclaimer', description: 'Important legal information and limitations of liability.' },
  { path: 'accessibility', title: 'Accessibility Statement', description: 'Our commitment to digital accessibility for all users.' }
];

for (const page of pages) {
  const dirPath = path.join('app', page.path);
    ...
    <main className="bg-white pt-32 pb-24">
      ...
      <section className="py-24">
        <div className="max-w-[1000px] mx-auto px-6 md:px-12 prose prose-lg prose-headings:font-serif prose-headings:text-tlg-midnight prose-p:text-gray-600 prose-p:font-light prose-a:text-tlg-signatureGold hover:prose-a:text-tlg-midnight max-w-none">
          ...
          <p>
            This is a placeholder for the ${page.title}. Please provide the official legal text to replace this content. We are committed to maintaining the highest standards of corporate governance, transparency, and compliance across all our operating jurisdictions, including the UAE, Canada, and Nigeria.
          </p>
